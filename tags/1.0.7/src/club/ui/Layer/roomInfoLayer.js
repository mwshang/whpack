var ClubRoomInfo = cc.Layer.extend(
    {
        ...
        ctor: function (data, packInfo) {
            this._super();
            var root = ccs.load(ClubJson.RoomInfo).node;
            this.addChild(root);
            ...
            // 底金
            this.text_baseScore = ccui.helper.seekWidgetByName(root, "text_dijin");
        ...
        updateRoomInfo: function () {
            ...
            this.text_baseScore.setString(basecashdata.getBaseCashDesc(config.baseScore));
...
var ClubInviteRoomInfo = cc.Layer.extend(
    {
        ...
        ctor: function (data) {
            this._super();
            var root = ccs.load(ClubJson.InviteRoomInfo).node;
            this.addChild(root);
        ...
        updateRoomInfo: function () {
            ...
            this.text_name.setString(roomName);
            this.text_name.setContentSize(this.text_name.getVirtualRendererSize());
            this.text_qunname.setString(data.packName || "俱乐部");
            this.text_qunname.setContentSize(this.text_qunname.getVirtualRendererSize());
