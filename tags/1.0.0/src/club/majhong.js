...
var club = {
    ...
    gameBackClub: function () {
        JJLog.print("检查是否从俱乐部游戏返回大厅", this.gamePackId);
    ...
    quitPack: function (packInfo) {
        ...
        DecideDialog.setDes("确定要退出俱乐部" + packInfo.name + "吗");
    ...
    initOnlineList: function (data) {
        ...
        // this.state_player = {};
        // this.state_room = {};
        console.log("@@@@@@@@ initOnlineList =>", data);
        // if (this.isInit) {
        // }
        // this.isInit = true;
        for (var key in data) {
        ...
        console.log("@@@@@@@@@@@ online list", this.onlineList);
    },
    playerEnter: function (data) {
        ...
        console.log("@@@@@@@@@@@@@@@playerEnter =>", this.onlineList, data);
    },
    playerLeave: function (data) {
        ...
        this.state_player[pid] = true;
        console.log("@@@@@@@@@@@@@@@playerLeave =>", this.onlineList, data);
    },
    playerState: function (data) {
        ...
        this.state_player[pid] = true;
        console.log("@@@@@@@@@@@@@@@playerState =>", this.onlineList, data);
    },
    packNotifyJoin: function (data) {
        console.log("packNotifyJoin =>", data);
        var dialog = new JJConfirmDialog();
        // dialog.setDes("你对" + data.name + "的申请已被通过, 快进去体验俱乐部功能吧!");
        dialog.setDes("你已经加入俱乐部" + data.name + ", 快进去体验俱乐部功能吧!");
        dialog.showDialog();
    },
    packNotifyRejectJoin: function (data) {
        console.log("packNotifyRejectJoin=>", data);
        var dialog = new JJConfirmDialog();
